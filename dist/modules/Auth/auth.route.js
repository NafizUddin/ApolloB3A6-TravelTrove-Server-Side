...
router.post('/social-login', auth_controller_1.AuthControllers.socialLogin);
...
router.post('/reset-password', (0, validateRequest_1.default)(auth_validation_1.AuthValidation.changePasswordValidationSchema), auth_controller_1.AuthControllers.resetPassword);
