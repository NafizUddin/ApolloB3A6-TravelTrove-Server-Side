...
const initiatePayment = (paymentData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(config_1.default.payment_url, {
            ...
            success_url: `https://traveltrove-server.vercel.app/api/payments/confirmation?transactionId=${paymentData.transactionId}&status=success`,
            fail_url: `https://traveltrove-server.vercel.app/api/payments/confirmation?status=failed`,
            cancel_url: 'https://apollob3a6-traveltrove-guide.vercel.app/',
